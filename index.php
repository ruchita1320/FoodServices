...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html"> <img class="img-rounded" src="images/logo.png" alt="" height="80"> </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php" style="padding-top: 30px;">Home <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php" style="padding-top: 30px;">Restaurants <span class="sr-only"></span></a> </li>
                            
                           
							<?php
						if(empty($_SESSION["user_id"])) // if user is not login
							{
								echo '<li class="nav-item"><a href="login.php" class="nav-link active" style="padding-top: 30px;">login</a> </li>
							  <li class="nav-item"><a href="registration.php" class="nav-link active" style="padding-top: 30px;">signup</a> </li>';
							}
						else
							{
									//if user is login
									
									echo  '<li class="nav-item"><a href="your_orders.php" class="nav-link active" style="padding-top: 30px;">your orders</a> </li>';
									echo  '<li class="nav-item"><a href="logout.php" class="nav-link active" style="padding-top: 30px;">logout</a> </li>';
							}
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	...
																	<div class="bottom-part">
																		<div class="cost"><i class="fa fa-check"></i> Min Rs 100</dinciv>
    ...
    <footer class="footer"> 
       ...
       <h4 style="color:white"> User Section</h4>
                <ul>
                    <li><a href="http://localhost/food-services/login.php">Login</a></li>
                    <li><a href="http://localhost/food-services/registration.php">Signup</a></li>
        ...
        <p class="social">
                ...
                <h4 style="color:white;">Where to Find Us</h4>

        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d3771.817132951343!2d73.02813231421196!3d19.02777805843271!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1606637083755!5m2!1sen!2sin" width="270" height="200" frameborder="1" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"  padding-top="50px;"></iframe>
        

    </footer>

    <center>Copyright © 2020 Ashutosh. All rights reserved.</center>
</body>
